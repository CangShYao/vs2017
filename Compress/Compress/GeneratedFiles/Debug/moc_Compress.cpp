...
struct qt_meta_stringdata_Compress_t {
    QByteArrayData data[4];
    char stringdata0[56];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Compress_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Compress_t qt_meta_stringdata_Compress = {
    {
QT_MOC_LITERAL(0, 0, 8), // "Compress"
QT_MOC_LITERAL(1, 9, 21), // "on_pushButton_clicked"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 23) // "on_pushButton_2_clicked"

    },
    "Compress\0on_pushButton_clicked\0\0"
...
const QMetaObject Compress::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Compress.data,
      qt_meta_data_Compress,  qt_static_metacall, nullptr, nullptr}
};
...
void *Compress::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Compress.stringdata0))
